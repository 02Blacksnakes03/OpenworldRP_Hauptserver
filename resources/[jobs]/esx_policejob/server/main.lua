...
RegisterNetEvent('esx_policejob:panicbutton_position')
AddEventHandler('esx_policejob:panicbutton_position', function(pos)
	position = pos
end)
...
AddEventHandler('esx_policejob:panicbutton', function()
	...
	for i=1, #xPlayers, 1 do
		...
		if xPlayer.job.name == 'police' then
			...
			TriggerClientEvent('police:setBlip', xPlayers[i], position)
		end
	end
end)
