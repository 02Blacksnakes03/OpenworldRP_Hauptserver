...
Config.Zones = {
	...
	ls1 = {
		...
		Size  = {x = 18.0, y = 18.0, z = 1.6},
		Color = {r = 106, g = 196, b = 191},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls2 = {
		Pos   = { x = -211.39, y = -1322.22, z = 30.89},
		Size  = {x = 18.0, y = 18.0, z = 1.6},
		Color = {r = 106, g = 196, b = 191},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls3 = {
		Pos   = { x = 731.45, y = -1088.9, z = 21.71},
		Size  = {x = 10.0, y = 10.0, z = 1.6},
		Color = {r = 106, g = 196, b = 191},
		Marker= 1,
		Name  = _U('blip_name'),
		Hint  = _U('press_custom')
