...
-- GENERAL --
Config.MenuTitle = 'Phoenix-V' -- change it to you're server name
...
Config.Admin = {
...

	{
		...
		groups = {'owner', 'admin', 'administrator', 'teamleiter'},
		command = function()
			RageUI.CloseAll()
			Citizen.Wait(100)
			TriggerEvent('skinchanger:loadDefaultModel', true)
...

	{
		name = 'changeskin',
		label = 'Moderator',
		groups = {'owner', 'admin', 'mod', 'teamleiter'},
		command = function()
			RageUI.CloseAll()
			Citizen.Wait(100)
			TriggerEvent('skinchanger:loadDefaultModel', true)
	...
	--[[
	{
		...
		groups = {'_dev', 'owner', 'admin', 'teamleiter'},
		command = function()
			RageUI.CloseAll()
			Citizen.Wait(100)
			TriggerEvent('skinchanger:loadDefaultModel', true)
	...
	]]--
	{
		name = 'changeskin4',
		label = 'Supporter',
		groups = {'_dev', 'owner', 'admin', 'teamleiter', 'supporter'},
		command = function()
			RageUI.CloseAll()
			Citizen.Wait(100)
			TriggerEvent('skinchanger:loadDefaultModel', true)
...

	{
		name = 'changeskin',
		label = 'Einreise M',
		groups = {'_dev', 'owner', 'admin', 'mod', 'teamleiter', 'supporter', 'administrator'},
		command = function()
			RageUI.CloseAll()
			Citizen.Wait(100)
			TriggerEvent('skinchanger:loadDefaultModel', true)
...
--				glasses_2    = 0,
...

	{
		...
		groups = {'_dev', 'owner', 'admin', 'mod', 'admin', 'sadmin', 'teamleiter', 'supporter', 'administrator'},
		command = function()
