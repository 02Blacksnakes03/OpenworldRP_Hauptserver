...
ESX.RegisterUsableItem('kettenhemd', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent('esx_extraitems:kettenhemd', source)
	if Config.Removeables.BulletProofVest then
		xPlayer.removeInventoryItem('kettenhemd', 1)
		xPlayer.showNotification(_U('used_kettenhemd'))
	end
end)

ESX.RegisterUsableItem('leinenstoff', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent('esx_extraitems:leinenstoff', source)
	if Config.Removeables.BulletProofVest then
		xPlayer.removeInventoryItem('leinenstoff', 1)
		xPlayer.showNotification(_U('used_leinenstoff'))
	end
end)
...
ESX.RegisterUsableItem('heavybulletproof', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent('esx_extraitems:heavybulletproof', source)
	if Config.Removeables.BulletProofVest then
		xPlayer.removeInventoryItem('heavybulletproof', 1)
		xPlayer.showNotification(_U('used_heavybulletproof'))
	end
end)
