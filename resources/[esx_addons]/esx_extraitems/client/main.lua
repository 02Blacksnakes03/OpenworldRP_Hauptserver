...
AddEventHandler('esx_extraitems:bulletproof', function()
	...
	AddArmourToPed(playerPed, 60)
	--SetPedArmour(playerPed, 100)
end)
-- End of Bullet Proof Vest

-- Start of Kettenhemd
RegisterNetEvent('esx_extraitems:kettenhemd')
AddEventHandler('esx_extraitems:kettenhemd', function()
	local playerPed = GetPlayerPed(-1)
...
-- End of Bullet Kettenhemd

-- Start of Bullet Leinenstoff
RegisterNetEvent('esx_extraitems:leinenstoff')
AddEventHandler('esx_extraitems:leinenstoff', function()
	local playerPed = GetPlayerPed(-1)
